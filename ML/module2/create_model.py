...
# def one_dim_CNN_model(input_shape, n_class, conv1_filters=64, kernel1_size=20, stride1=2, stride2=1, conv2_filters=32, kernel2_size=15, conv3_filters=64,
...
#     x = Conv1D(conv1_filters, kernel1_size, strides=stride1, activation='relu', padding='same', name="L1")(input_layer)
#     x = BatchNormalization()(x)
#     x = Activation("elu")(x)
#     x = SeparableConv1D(conv2_filters, kernel2_size, strides=stride1, activation='relu', padding='valid', name="L2")(x)
#     x = AveragePooling1D(2, name="L3")(x)
#     x = Conv1D(conv3_filters, kernel3_size, strides=stride2, activation='relu', padding='same', name="L4")(x)
#     x = BatchNormalization()(x)
#     x = Activation("elu")(x)
#     x = SeparableConv1D(conv4_filters, kernel4_size, strides=stride2, activation='relu', padding='valid', name="L5")(x)
#     x = Flatten(name="L6")(x)
#     x = Dense(dense1_nodes, activation='relu', name="L7")(x)
#     x = Dropout(dropout_rate)(x)
#     x = Dense(dense2_nodes, activation='relu', name="L8")(x)
