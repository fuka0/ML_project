        ...
        for target_subject in target_subjects:
            if target_subject == "S018" or target_subject == "S032" or target_subject == "S004":
                ...
                for train, test in sss.split(X, y):
                    ...
                    # history = model.fit(X_train_combined, y_train_combined, epochs=1, batch_size=3000, validation_data=(X_test, y_test), callbacks=callbacks_list)
            # 転移学習part//////////////////////////////////
                group_results = []
                sstl_train_acc_list = []
                sstl_val_acc_list = []
                ...
                for train, test in sss.split(X_sstl, y_sstl):
                    ...
                    # history_sstl = global_model.fit(X_train_sstl, y_train_sstl, epochs=1, batch_size=3000, validation_data=(X_test_sstl, y_test_sstl), callbacks=sstl_callbacks_list)
