...
nam_class = [2, 3, 4] # How many class to classify (2 for left and right hands, 3 add for both hands, 4 add for both feet)
...
dss = [3] # down sampling rate(1/2, 1/3)
# ds = 2
...
filename_change = f"_multi_4"

for n_class in nam_class:
    for ds in dss:
